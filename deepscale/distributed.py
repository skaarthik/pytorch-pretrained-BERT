#Original torch.nn.parallel.distribute.py in torch v0.4.1

#Modified by: Samyam Rajbhandari for better efficiency
#Email: samyamr@microsoft.com
...
class DistributedDataParallel(Module):
    ...
    def __init__(self, module, device_ids=None, output_device=None, dim=0,
        ...
        if dist._backend == dist.dist_backend.NCCL:
            print("Registering NCCL Grad Hook")
    ...
    def _register_nccl_grad_hook(self):
        ...
        def reduction_fn_nccl():
            ...
            if not self.need_reduction:
                #print("Reduction already done")
                return
            #print("Reduction not done")
            #self.need_reduction = False
